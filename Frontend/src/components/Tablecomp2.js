...
const Tablecomp = (props) => {
  ...
  console.log(props.globalPipelin + "here");
const filteredDataList = props.globalPipeline === "All" 
  ? dummyDataList 
  : dummyDataList.filter(parent => parent.PipelineName === props.globalPipeline);
